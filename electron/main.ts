...
function hideMainWindow(): void {
  ...
  if (!state.mainWindow || state.mainWindow.isDestroyed()) {
    console.warn("Cannot hide window: mainWindow is null or destroyed");
    return;
  }

  // Store reference to avoid null reference during execution
...
function showMainWindow(): void {
  // Additional null check to prevent race conditions
  if (!state.mainWindow || state.mainWindow.isDestroyed()) {
    console.warn("Cannot show window: mainWindow is null or destroyed");
    return;
  }
