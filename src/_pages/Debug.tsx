    ...
    <div className="space-y-2 relative">
      ...
      {isLoading ? (
        ...
        <div className="w-full relative">
          ...
          {/* Scrollable container for the debug code block */}
          <div className="max-h-[36rem] overflow-y-auto rounded-lg border border-gray-700/50">
            <SyntaxHighlighter
              showLineNumbers
              ...
              customStyle={{
                ...
                maxHeight: "none", // Remove any height constraints from the syntax highlighter itself
              }}
              wrapLongLines={true}
            >
              {code as string}
  ...
  useEffect(() => {
    ...
    if (newSolution) {
      ...
      if (newSolution.debug_analysis) {
        ...
        setThoughtsData(
          newSolution.thoughts || ["Debug analysis based on your screenshots"],
        );
      }
      setTimeComplexityData(newSolution.time_complexity || "N/A - Debug mode");
      setSpaceComplexityData(
        newSolution.space_complexity || "N/A - Debug mode",
      );
      ...
      window.electronAPI.onDebugSuccess(
        (data: {
          ...
          if (data.debug_analysis) {
            ...
            setThoughtsData(
              data.thoughts || ["Debug analysis based on your screenshots"],
            );
  ...
  return (
    <div ref={contentRef} className="relative">
      <div className="space-y-3 px-4 py-3">
        ...
        {/* Main Content */}
        <div className="w-full text-sm text-black bg-black rounded-md">
          <div className="rounded-lg overflow-hidden">
            <div className="px-4 py-3 space-y-4">
              ...
              {/* Complexity Section - moved above code for better visibility */}
              <ComplexitySection
              ...
              {/* Code Section - now with scrollability and copy functionality */}
              <DebugCodeSection
                title="Debug Code"
                code={newCode}
                isLoading={!newCode}
                ...
                {!debugAnalysis ? (
                  ...
                  <div className="w-full bg-black/30 rounded-md p-4 text-[13px] leading-[1.4] text-gray-100 whitespace-pre-wrap overflow-auto max-h-[600px]">
                    ...
                    {(() => {
                      ...
                      const mainSections = debugAnalysis.split(
                        /(?=^#{1,3}\s|^\*\*\*|^\s*[A-Z][\w\s]+\s*$)/m,
                      );
                      ...
                      mainSections.filter(Boolean).forEach((sectionText) => {
                        ...
                        if (
                          ...
                          (lines[0].startsWith("#") ||
                            ...
                            lines[0].includes("Issues") ||
                            lines[0].includes("Improvements") ||
                            lines[0].includes("Optimizations"))
                        ) {
                                ...
                                if (line.trim().startsWith("```")) {
                                  ...
                                  if (
                                    ...
                                    if (codeBlockEndIndex > lineIndex) {
                                      // Extract language if specified (currently unused but available for future enhancement)
